...
namespace gfx
{
    VulkanTexture::VulkanTexture(const TextureImporter& importer)
    {
...

        {
            ...
            auto stagingBuffer = Buffer::CreateStaging(textureData.size(), textureData.data());
    ...
    void VulkanTexture::TransitionImageLayout(vk::CommandBuffer& cmdBuffer, vk::Image image, vk::ImageLayout oldLayout, vk::ImageLayout newLayout)
    {
