...
struct QueueFamilyIndices
{
    ...
    auto is_complete() const -> bool { return graphicsFamily.has_value() && presentFamily.has_value(); }
};
...
void HelloTriangle_Raw::framebuffer_resize_callback(GLFWwindow* window, int width, int height)
{
    auto* app = static_cast<HelloTriangle_Raw*>(glfwGetWindowUserPointer(window));
    app->m_frameBufferResized = true;
}

void HelloTriangle_Raw::run()
{
    init_window();
    init_vulkan();
    main_loop();
...
void HelloTriangle_Raw::init_window()
{
    // Initialise GLFW
    glfwInit();
...
void HelloTriangle_Raw::create_vulkan_instance()
{
...
void HelloTriangle_Raw::create_surface()
{
...
void HelloTriangle_Raw::pick_physical_device()
{
...
void HelloTriangle_Raw::create_logical_device()
{
...
void HelloTriangle_Raw::create_swap_chain()
{
...
void HelloTriangle_Raw::create_image_views()
{
...
void HelloTriangle_Raw::create_render_pass()
{
...
void HelloTriangle_Raw::create_graphics_pipeline()
{
...
void HelloTriangle_Raw::create_framebuffers()
{
...
void HelloTriangle_Raw::create_command_pool()
{
...
void HelloTriangle_Raw::create_command_buffers()
{
...
void HelloTriangle_Raw::create_sync_objects()
{
...
void HelloTriangle_Raw::init_vulkan()
{
...
void HelloTriangle_Raw::draw_frame()
{
...
void HelloTriangle_Raw::main_loop()
{
...
void HelloTriangle_Raw::cleanup_swap_chain()
{
...
void HelloTriangle_Raw::cleanup()
{
    cleanup_swap_chain();
...
void HelloTriangle_Raw::recreate_swap_chain()
{
    int width = 0;
    int height = 0;
...
auto HelloTriangle_Raw::check_validation_layer_support() -> bool
{
...
void HelloTriangle_Raw::list_supported_extensions()
{
...
auto HelloTriangle_Raw::find_queue_families(vk::PhysicalDevice device) -> QueueFamilyIndices
{
...
auto HelloTriangle_Raw::check_device_extension_support(vk::PhysicalDevice device) -> bool
{
...
auto HelloTriangle_Raw::query_swap_chain_support(vk::PhysicalDevice device) -> SwapChainSupportDetails
{
...
auto HelloTriangle_Raw::is_device_suitable(vk::PhysicalDevice device) -> bool
{
...
auto HelloTriangle_Raw::choose_swap_surface_format(const std::vector<vk::SurfaceFormatKHR>& availableFormats) -> vk::SurfaceFormatKHR
{
...
auto HelloTriangle_Raw::choose_swap_present_mode(const std::vector<vk::PresentModeKHR>& availablePresentModes) -> vk::PresentModeKHR
{
...
auto HelloTriangle_Raw::choose_swap_extent(const vk::SurfaceCapabilitiesKHR& capabilities) -> vk::Extent2D
{
...
auto HelloTriangle_Raw::create_shader_module(const std::vector<char>& code) -> vk::ShaderModule
{
